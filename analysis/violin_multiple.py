...
csv_files = [
    "timings_c_vm.csv",
    "timings_c_vm_100.csv",  # Add your other files here
]
...
x_min = max(0, global_min - padding)  # Don't go below 0 for duration
...
for i, csv_file in enumerate(csv_files):
    ...
    # Create violin plot with aligned x-axis
    sns.violinplot(x=durations, ax=axes[i], color='lightblue', linewidth=1.5)
...
plt.tight_layout()
plt.savefig("combined_latency_violinplots_aligned_vm.png", bbox_inches='tight')
plt.close()
